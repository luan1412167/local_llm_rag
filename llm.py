...
condense_question = """Given the following conversation and a follow up question, rephare the follow up question to be a standalone question.
...
DEFAULT_DOCUMENT_PROMPT = PromptTemplate.from_template(template="Source Document: {source}, Page {page}:\n {page_content}")
